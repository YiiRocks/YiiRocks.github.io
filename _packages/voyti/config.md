  ...
  session:
    ...
    - name: passwordPolicy
      ...
      options:
        ...
        - name: maxLength
          type: int
          default: "<code>72</code>"
          desc: "Maximum password length. Must not be smaller than <code>minLength</code>."
        - name: minUppercase
          type: int
          default: "<code>0</code>"
          desc: "Minimum Unicode uppercase (<code>Lu</code>) characters."
        - name: minLowercase
          type: int
          default: "<code>0</code>"
          desc: "Minimum Unicode lowercase (<code>Ll</code>) characters."
        - name: minDigits
          type: int
          default: "<code>0</code>"
          desc: "Minimum Unicode decimal-digit (<code>Nd</code>) characters."
        - name: minSymbols
          type: int
          default: "<code>0</code>"
          desc: "Minimum characters outside Unicode letters and numbers."
...
<h3 class="h5 text-uppercase fw-bold pb-2 mb-3 border-bottom border-2 text-primary-emphasis section-label">Authentication &amp; Registration</h3>
...
<h3 class="h5 text-uppercase fw-bold pb-2 mb-3 border-bottom border-2 text-primary-emphasis section-label">Admin Dashboard</h3>
