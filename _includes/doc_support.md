...
{% assign level = include.level | default: 2 %}
    <h{{ level }} class="h5 text-uppercase fw-bold pb-2 mb-3 border-bottom border-2 text-primary-emphasis section-label" id="support">Support</h{{ level }}>
    <div class="mb-3 d-flex align-items-center gap-2 flex-wrap">
        ...
        <a href="https://github.com/YiiRocks/{{ pkg.repo }}/issues" target="_blank" rel="noopener" class="btn btn-primary btn-arrow btn-sm small fw-semibold">Create an issue</a>
    </div>
{% endif %}
